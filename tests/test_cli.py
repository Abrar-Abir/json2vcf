...
class TestCLI:
    def test_basic_invocation(self, minimal_snv_json_gz, tmp_path):
        """json2vcf -i input.json.gz -o output.vcf produces output file."""
    ...
    def test_output_to_stdout(self, minimal_snv_json_gz, capsys):
        """json2vcf -i input.json.gz (no -o) writes to stdout."""
    ...
    def test_missing_input_file(self):
        """json2vcf -i nonexistent.json.gz exits with error."""
